...
makedocs(; modules = [FractionalDiffEq],
    authors = "Qingyu Qu",
    ...
    doctest = false,
    pages = ["FractionalDiffEq.jl" => "index.md", "Get Started" => "get_started.md",
        ...
        ChaosGallery, "Problems" => "problems.md", "Algorithms" => "algorithms.md",
        "Mittag Leffler Function" => "mittagleffler.md", "Comparison" => "comparison.md"])

postprocess_cb()

deploydocs(; repo = "github.com/SciFracX/FractionalDiffEq.jl",)
